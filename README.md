...
| **last_updated_on**          | Last Updated On          | ISO 8601 format (e.g. YYYY-MM-DD)   
...
| ***cost_sharing***             | Cost Sharing             | Array of cost sharing values (see "Cost sharing sub-type" below)                                                                              | Always   |                                                                       | Always   |
...
| **copay_opt**        | Copay option       | Qualifier of copay amount (Values: `AFTER-DEDUCTIBLE`, `BEFORE-DEDUCTIBLE`, `NO-CHARGE`, `NO-CHARGE-AFTER-DEDUCTIBLE` | No       |
| **coinsurance_rate** | Coinsurance rate   | Rate of coinsurance (float, 0.0 to 1.0)                                                                    | Always   |
| **coinsurance_opt** | Coinsurance option | Qualifier for coinsurance rate (Values: `AFTER-DEDUCTIBLE`, `NO-CHARGE`, `NO-CHARGE-AFTER-DEDUCTIBLE`)                | No       |
...
| **specialty** | Specialty Type     | -                                                           | Always   |
...
| **facility_type** | Facility Type      | -           | Always   |
| **address**       | Address            | -           | Always   |
| ***address***     | Street Address   | -           | Always       |
| ***address_2***     | Street Address 2   | -           | No       |
| ***city***        | City               | -           | Always   |
